...
class CalculadoraTest {
    ...
    static CalculadoraTest miCalculadora;
    ...
    void testMultiplicar() {
        assertEquals(6, miCalculadora.testMultiplicar(2,3));
        assertEquals(0, miCalculadora.testMultiplicar(5,0));
        assertEquals(16, miCalculadora.testMultiplicar(4,4));
        assertEquals(-5, miCalculadora.testMultiplicar(-5,1));
    }
